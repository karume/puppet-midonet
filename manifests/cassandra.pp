...
class midonet::cassandra (
  $seeds              = $midonet::params::cassandra_seeds,
  $seed_address       = $midonet::params::seed_address,
  $storage_port       = $midonet::params::storage_port,
  $ssl_storage_port   = $midonet::params::ssl_storage_port,
  $client_port        = $midonet::params::client_port,
  $client_port_thrift = $midonet::params::client_port_thrift,
