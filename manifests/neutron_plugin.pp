...
#
class midonet::neutron_plugin (
  $midonet_api_ip            = $midonet::params::api_ip,
  $midonet_api_port          = $midonet::params::api_port,
  $neutron_keystone_username = $midonet::params::neutron_keystone_username,
  ...
  class { 'neutron::plugins::midonet':
    ...
    keystone_username => $neutron_keystone_username,
    keystone_password => $neutron_keystone_password,
    keystone_tenant   => $neutron_keystone_tenant,
    sync_db           => $sync_db
  }
